...
export const PenaltyCardDisplay: React.FC<Props> = ({ card, runtime, className = '', style, isAnimating }) => {
  ...
  return (
    ...
    >
        ...
        {/* Tooltip */}
        <div className="absolute top-0 left-full ml-4 w-60 bg-[#1a0505] border-2 border-[#ef4444] p-4 pixel-corners opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none z-[200] shadow-[0_0_30px_rgba(220,38,38,0.2)]">
